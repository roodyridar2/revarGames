  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div className="absolute w-full h-full rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center backface-hidden shadow-lg">
          <img
            src={foodCardCover}
            alt="card back"
        ...
        >
          ...
          <div className="flex justify-center mb-6">
            <div className="bg-gray-100 rounded-lg p-1 flex">
              ...
              <motion.button
                className={`px-3 py-1 rounded-md ${
                  language === "ku" ? "bg-white shadow-sm" : ""
                }`}
            ...
            >
              ...
              >
                <h2 className="text-3xl font-bold mb-2 text-purple-600">
                  {t(
                    gameEndReason.includes("matched")
                      ? "allCardsMatched"
                      : "timeUp"
                  )}
                </h2>
